...
public class No10815Test {
    File path = new File(".");
    String input = path.getAbsolutePath() + "/src/test/java/boj/problems/No10815_input.txt";
    String output = path.getAbsolutePath() + "/src/test/java/boj/problems/No10815_output.txt";
